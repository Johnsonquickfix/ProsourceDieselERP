        ...
        columns: [
            ...
            { data: 'Exported', title: 'Exported', sWidth: "10%" },
            {
                'data': 'id', title: 'Action', sWidth: "8%", 'render': function (id, type, row, meta) {
                    ...
                    if ($("#hfEdit").val() == "1") {
                        if (_editable == 1) {
                            if ((row.status == 'wc-pending' || row.status == 'wc-pendingpodiuminv') && refund_amt == 0) return '<a href="../Orders/quickorder/' + id + '" data-toggle="tooltip" title="View/Edit Order" onclick="ActivityLog(\'View/Edit order id (' + id + ') in order history.\',\'/OrdersMySQL/OrdersHistory/' + id + '\'); return true;"><i class="glyphicon glyphicon-eye-open"></i></a> <a href="javascript:void(0);" onclick="cancelorder(' + id + ');" data-toggle="tooltip" title="Cancel Order"><i class="fa fa-times-circle text-danger"></i></a>';
                            else if ((row.status == 'wc-pending' || row.status == 'wc-pendingpodiuminv') && refund_amt != 0) return '<a href="../Orders/quickorder/' + id + '" data-toggle="tooltip" title="View/Edit Order" onclick="ActivityLog(\'View/Edit order id (' + id + ') in order history.\',\'/OrdersMySQL/OrdersHistory/' + id + '\'); return true;"><i class="glyphicon glyphicon-eye-open"></i></a>';
                            ...
                            else if (row.status == 'wc-completed') return '<a href="../Orders/quickorder/' + id + '" data-toggle="tooltip" title="View/Edit Order" onclick="ActivityLog(\'View/Edit order id (' + id + ') in order history.\',\'/Orders/OrdersHistory/' + id + '\'); return true;"><i class="glyphicon glyphicon-eye-open"></i></a> <a href="javascript:void(0);" data-toggle="tooltip" title="Refund Order" onclick="OrderRefund(' + id + ');"><i class="fa fa-undo"></i></a>';
                            else return '<a href="../Orders/quickorder/' + id + '" data-toggle="tooltip" title="View/Edit Order" onclick="ActivityLog(\'View/Edit order id (' + id + ') in order history.\',\'/Orders/OrdersHistory/' + id + '\'); return true;"><i class="glyphicon glyphicon-eye-open"></i></a>';
                        }
                        else if (_editable == 0 && _id == row.customer_id) {
                            if ((row.status == 'wc-pending' || row.status == 'wc-pendingpodiuminv') && refund_amt == 0) return '<a href="../Orders/quickorder/' + id + '" data-toggle="tooltip" title="View/Edit Order" onclick="ActivityLog(\'View/Edit order id (' + id + ') in order history.\',\'/Orders/OrdersHistory/' + id + '\'); return true;"><i class="glyphicon glyphicon-eye-open"></i></a> <a href="javascript:void(0);" onclick="cancelorder(' + id + ');" data-toggle="tooltip" title="Cancel Order"><i class="fa fa-times-circle text-danger"></i></a>';
                            else if ((row.status == 'wc-pending' || row.status == 'wc-pendingpodiuminv') && refund_amt != 0) return '<a href="../Orders/quickorder/' + id + '" data-toggle="tooltip" title="View/Edit Order" onclick="ActivityLog(\'View/Edit order id (' + id + ') in order history.\',\'/Orders/OrdersHistory/' + id + '\'); return true;"><i class="glyphicon glyphicon-eye-open"></i></a>';
                            else if ((row.status == 'wc-processing' || row.status == 'wc-on-hold') && refund_amt == 0) return '<a href="../Orders/quickorder/' + id + '" data-toggle="tooltip" title="View/Edit Order" onclick="ActivityLog(\'View/Edit order id (' + id + ') in order history.\',\'/Orders/OrdersHistory/' + id + '\'); return true;"><i class="glyphicon glyphicon-eye-open"></i></a> <a href="javascript:void(0);" data-toggle="tooltip" title="Refund Order" onclick="OrderRefund(' + id + ');"><i class="fa fa-undo"></i></a> <a href="javascript:void(0);" onclick="cancelorder(' + id + ');" data-toggle="tooltip" title="Cancel Order"><i class="fa fa-times-circle text-danger"></i></a>';
                            else if ((row.status == 'wc-processing' || row.status == 'wc-on-hold') && refund_amt != 0) return '<a href="../Orders/quickorder/' + id + '" data-toggle="tooltip" title="View/Edit Order" onclick="ActivityLog(\'View/Edit order id (' + id + ') in order history.\',\'/Orders/OrdersHistory/' + id + '\'); return true;"><i class="glyphicon glyphicon-eye-open"></i></a> <a href="javascript:void(0);" data-toggle="tooltip" title="Refund Order" onclick="OrderRefund(' + id + ');"><i class="fa fa-undo"></i></a>';
                            else if (row.status == 'wc-completed') return '<a href="../Orders/quickorder/' + id + '" data-toggle="tooltip" title="View/Edit Order" onclick="ActivityLog(\'View/Edit order id (' + id + ') in order history.\',\'/Orders/OrdersHistory/' + id + '\'); return true;"><i class="glyphicon glyphicon-eye-open"></i></a> <a href="javascript:void(0);" data-toggle="tooltip" title="Refund Order" onclick="OrderRefund(' + id + ');"><i class="fa fa-undo"></i></a>';
                            else return '<a href="../Orders/quickorder/' + id + '" data-toggle="tooltip" title="View/Edit Order"  onclick="ActivityLog(\'View/Edit order id (' + id + ') in order history.\',\'/Orders/OrdersHistory/' + id + '\'); return true;"><i class="glyphicon glyphicon-eye-open"></i></a>';
                            ...
                            return '<a href="../Orders/quickorder/' + id + '" onclick="ActivityLog(\'Edit order id (' + id + ') in order history.\',\'/Orders/OrdersHistory/' + id + '\'); return true;" data-toggle="tooltip" title="View/Edit Order"><i class="glyphicon glyphicon-eye-open"></i></a>';
                        }
                    }
