...
namespace LaylaERP.Controllers
{
    public class PurchaseOrderController : Controller
    {
        ...
        public JsonResult GetPurchaseOrderList(JqDataTableModel model)
        {
            ...
            try
            {
                DataTable dt = PurchaseOrderRepository.GetPurchaseOrder(model.strValue1, model.sSearch, model.iDisplayStart, model.iDisplayLength,model.strValue2, out TotalRecord, model.sSortColName, model.sSortDir_0);
                result = JsonConvert.SerializeObject(dt);
            }
            catch (Exception ex) { throw ex; }
