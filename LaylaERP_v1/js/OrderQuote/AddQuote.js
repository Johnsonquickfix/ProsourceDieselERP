...
function getQuoteInfo() {
    ...
    if (oid > 0) {
        ...
        $('.page-heading').text('Edit Order ').append('<a class="btn btn-danger" href="/OrderQuote/History" data-toggle="tooltip" data-placement="right" title="Back to List">Back to List</a>');
