...
namespace LaylaERP.BAL
{
    public class CMSRepository  
    {
        ...
        public static int CreatePage(string qflag, string ID, string post_title, string post_content, string InnerPageBannerLink, string entity_id, string SEO, string Content)
        {
            try
            {
                SqlParameter[] para = {
