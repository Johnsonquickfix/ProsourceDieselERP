   ...
   // console.log('hj');
    ...
    $(result).each(function (index, tr) {
        if (tr.product_type == 'line_item') {
           ...
           // console.log(tr);
            //console.log(index);
            myHtml += '<tr><td style="border-top: 1px solid rgba(0, 0, 0, 0.1);  padding: 9px 12px; vertical-align: middle;"><span>' + tr.product_name + '</span><strong class="product-quantity">× ' + tr.quantity + '</span></td><td style="border-top: 1px solid rgba(0, 0, 0, 0.1);  padding: 9px 12px; vertical-align: middle;"><span>$' + tr.price.toFixed(2)  + '</span></td></tr>';
    ...
    myHtml += '<tr><th style="font-weight: 700; border-top: 1px solid rgba(0, 0, 0, 0.1);padding: 9px 12px; vertical-align: middle;">Shipping:</th><td style="font-weight: 700; border-top: 1px solid rgba(0, 0, 0, 0.1);padding: 9px 12px; vertical-align: middle;"><span>$' + zShippingAmt.toFixed(2) + '</span></td></tr>';
