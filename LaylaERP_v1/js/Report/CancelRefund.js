...
function Search() {
    ...
    if (type == "0") { swal('alert', 'Please select type', 'error'); }
    ...
    $('#dtdata').DataTable({
        ...
        searching: false,
        "ajax": {
            "url": '/Reports/GetStatusOrder',
            "type": 'POST',
            "dataType": 'json',
            "data": { Month: sd, Year: ed, Type: type }
        ...
        "columns": [
            ...
            { data: 'billing_state', title: 'Gift Card', class: 'text-right', sWidth: "10%", render: $.fn.dataTable.render.number('', '.', 2, '$') },
            { data: 'total', title: 'Order Total', class: 'text-right', sWidth: "10%", render: $.fn.dataTable.render.number('', '.', 2, '$') },
            { data: 'first_name', title: 'Refund Total', class: 'text-right', sWidth: "10%", render: $.fn.dataTable.render.number('', '.', 2, '$') },
        ],
        columnDefs: [{
            orderable: false,
            data: null,
