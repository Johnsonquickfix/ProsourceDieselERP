namespace LaylaERP.Models.qfk.Enums
{
    ...
    public class Criteria
    {
        ...
        public static Dictionary<string, string> CriteriaType()
        {
            ...
            pairs.Add("customer-distance", "Someone's proximity to a location");
        ...
        public static List<KeySets> CriteriaOperator(string CriteriaType = "all")
        {
            ...
            else if (CriteriaType.ToLower().Trim().Equals("customer-distance"))
            {
                pairs.Add(new KeySets { value = "lt", label = "is", selected = true });
                pairs.Add(new KeySets { value = "gt", label = "is not" });
            }
            else
            {
                pairs.Add(new KeySets { value = "eq", label = "is", selected = true });
        ...
        public static List<KeySets> CriteriaUnit(string CriteriaType = "all")
        {
            List<KeySets> pairs = new List<KeySets>();
            if (CriteriaType.ToLower().Trim().Equals("customer-distance"))
            {
                pairs.Add(new KeySets { value = "miles", label = "miles", selected = true });
                pairs.Add(new KeySets { value = "kilometers", label = "kilometers" });
            }
            else
            {
