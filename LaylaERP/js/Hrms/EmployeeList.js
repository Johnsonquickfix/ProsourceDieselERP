...
function EmployeeList() {
    ...
    var table_EL = $('#EmployeeListdata').DataTable({
        ...
        aoColumns: [
            { data: 'name', title: 'Name', sWidth: "25%", class: 'text-left' },
            { data: 'email', title: 'Email', sWidth: "25%" },
            { data: 'phone', title: 'Phone', sWidth: "25%" },
            {
                'data': 'ID', sWidth: "25%",
                'render': function (id, type, full, meta) {
                    return '<a href="#" onclick="Deletewarehouse(' + id + ');"><i class="fas fa-pencil"></i></a>';
                }
            }
        ]
    });
