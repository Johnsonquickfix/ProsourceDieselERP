...
function formatPO(d) {
    let option = { strValue1: d.id }, wrHTML = '<table class="inventory-table1 table-blue table check-table table-bordered table-striped dataTable no-footer"><thead><tr><th style="width:20%; text-align:left; visibility:inherit; opacity:1;">Payment/Bill No</th><th style="width:10%; text-align:left; visibility:inherit; opacity:1;">Type</th><th style="width:35%; text-align:left; visibility:inherit; opacity:1;">Receive Date</th><th style="width:15%; text-align:left; visibility:inherit; opacity:1;">Transaction Id</th><th style="width:15%; text-align:left; visibility:inherit; opacity:1;">Debit</th><th style="width:30%; text-align:left; visibility:inherit; opacity:1;">Credit</th></tr></thead>';
    $.ajax({
        ...
        success: function (result) {
            ...
            $(result).each(function (index, row) {
                wrHTML += '<tr><td style="width:20%; text-align:left;"> ' + row.ref + ' </td><td style="width:10%; text-align:left;"> ' + row.Paid + ' </td><td style="width:35%; text-align:left;">' + row.date_creation + '</td><td style="width:15%; text-align:left;">' + row.transaction_id + '</td>';
            ...
            }); wrHTML += '<tr><td style="width:20%; text-align:left;"><strong>Total</strong></td><td></td><td></td><td></td><td style="width:15%; text-align:left;"><strong>' + '$' + total_dbtamount.toFixed(2) + '</strong></td><td style="width:15%; text-align:left;"><strong>' + '$' + total_crdamount.toFixed(2) +'</strong></td> </tr > ';
        },
