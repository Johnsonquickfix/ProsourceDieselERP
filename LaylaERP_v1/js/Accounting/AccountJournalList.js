...
function AccountJournalList(is_date) {
    ...
    var table_EL = $('#JournalListdata').DataTable({
        ...
        order: [[0, "desc"], [2, "desc"], [1, "asc"]], ordering: true, destroy: true, bProcessing: true, bServerSide: false, bAutoWidth: false, searching: true, responsive: true, lengthMenu: [[10, 20, 50], [10, 20, 50]],
        language: {
