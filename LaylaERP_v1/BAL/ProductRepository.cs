    ...
    public class ProductRepository
    {
        ...
        public static DataTable Getcalculatemargins(string strValue1, string userstatus, string strValue3, string strValue4, string searchid, int pageno, int pagesize, out int totalrows, string SortCol = "order_id", string SortDir = "DESC")
        {
            ...
            try
            {
                ...
                string strSql = "Select TOP 2000 *, cast(sale_price as numeric(18,2)) - cast(cast_prise as numeric(18,2)) Margin,cast(regula_price as numeric(18,2)) - cast(cast_prise as numeric(18,2)) regulaMargin,coalesce(convert(numeric(18,2),( ((cast(sale_price as numeric(18,2)) - cast(cast_prise as numeric(18,2))) * 100) / NULLIF(cast(sale_price as numeric(18,2)),0))),0) marginpersantage,coalesce(convert(numeric(18,2),( ((cast(regula_price as numeric(18,2)) - cast(cast_prise as numeric(18,2))) * 100) / NULLIF(cast(regula_price as numeric(18,2)),0))),0) regularmarginpersantage "
