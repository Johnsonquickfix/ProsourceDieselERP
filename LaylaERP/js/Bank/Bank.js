...
function AddBankAccount() {
    ...
    if (label == "") {
        ...
        swal('Alert', 'Please Enter Bnak Name', 'error').then(function () { swal.close(); $('#txtbankname').focus(); });
    }
    else if (bankcode == "") {
        ...
        swal('Alert', 'Please Enter Reference Name', 'error').then(function () { swal.close(); $('#txtowneraddress').focus(); });
    }
