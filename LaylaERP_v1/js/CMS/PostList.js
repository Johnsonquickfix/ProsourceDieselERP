...
function GetDetails() {
    var opt = { strValue1: '' };
    $.ajax({
        type: "POST", url: '/CMS/GetPostCount', contentType: "application/json; charset=utf-8", dataType: "json", data: JSON.stringify(opt),
...
function dataGridLoad(order_type) {
    ...
    $('#dtdata').DataTable({
        ...
        columns: [
            ...
            { data: 'category', title: 'Category', className: 'text-wrap',  sWidth: "22%" },
            { data: 'post_date', title: 'Post Date', className: 'text-wrap',  sWidth: "8%" },
