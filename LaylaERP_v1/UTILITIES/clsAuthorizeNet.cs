namespace LaylaERP.UTILITIES
{
    ...
    public class clsAuthorizeNet
    {
        ...
        public static dynamic CreditCardPayment(String ApiLoginID, String ApiTransactionKey, string invoice_Number, string coustomer, decimal amount, string cardNumber, int expirationDate, int cardCode)
        {
            ...
            // Add line Items
            var lineItems =   new lineItemType[0];
