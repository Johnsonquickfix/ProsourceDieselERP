...
$('#btndelete').click(function () {
    ...
    if (fk_rule == "") {
       ...
       // var obj = { fk_ShippingID: Shipping, countrycode: country }
        var obj = { fk_rule: fk_rule, countryshipping: country }
        $.ajax({
    ...
    $('#dtdata').DataTable({
        ...
        fnServerData: function (sSource, aoData, fnCallback, oSettings) {
            ...
            if (oSettings.aaSorting.length > 0) {
                var col = oSettings.aaSorting[0][0] == 0 ? "rulrname" : oSettings.aaSorting[0][0] == 1 ? "Country" : oSettings.aaSorting[0][0] == 2 ? "State" : oSettings.aaSorting[0][0] == 3 ? "vendrname" : oSettings.aaSorting[0][0] == 4 ? "title" : oSettings.aaSorting[0][0] == 5 ? "services" : "rowid";
