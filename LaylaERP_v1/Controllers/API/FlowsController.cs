    ...
    public class FlowsController : ApiController
    {
        ...
        public IHttpActionResult FlowCreate(Flow request)
        {
            try
            {
                ...
                var json_data = JsonConvert.DeserializeObject<JObject>(FlowsRepository.FlowAdd("create", om.login_company_id, om.UserID, JsonConvert.SerializeObject(request)).ToString());
        ...
        public IHttpActionResult Get(long id)
        {
            try
            {
                ...
                var json_data = JsonConvert.DeserializeObject<JObject>(FlowsRepository.FlowAdd("get", om.login_company_id, om.UserID, JsonConvert.SerializeObject(request)).ToString());
                if (json_data["status"] != null)
                {
