                ...
                success: function (data) {
                    ...
                    $.each(JSON.parse(i), function (key, value) {
                        ...
                        for (i = 0; i < _values.length; i++) {
                            varHTML += '<option value="' + _values[i] + '">Any ' + _values[i] + '</option>';
                        }
                       // varHTML += '</select ></td > ';
