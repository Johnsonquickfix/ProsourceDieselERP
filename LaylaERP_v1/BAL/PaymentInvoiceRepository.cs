...
namespace LaylaERP.BAL
{
    public class PaymentInvoiceRepository
    {
        ...
        public static DataTable GetcheckList(string flag, DateTime? fromdate, DateTime? todate, string searchid, int pageno, int pagesize, out int totalrows, string SortCol = "id", string SortDir = "DESC")
        {
            DataTable dt = new DataTable();
            totalrows = 0;
            try
