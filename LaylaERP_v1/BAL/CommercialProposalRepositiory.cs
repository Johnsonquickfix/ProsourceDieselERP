        ...
        public static int AddProposal(CommercialProposalModel model)
        {
            ...
            try
            {
                ...
                SqlParameter[] para =
                {
                    ...
                    new SqlParameter("@datec", Convert.ToDateTime(DateTime.UtcNow.ToString())),
                    new SqlParameter("@datep", model.datep),
                    new SqlParameter("@fin_validite", fin_validity),
                    new SqlParameter("@validity_duration", model.validity_duration),
                    new SqlParameter("@payment_term", model.payment_term),
                    new SqlParameter("@balance", model.balance),
                    new SqlParameter("@payment_type", model.payment_type),
                    new SqlParameter("@fk_availability",model.fk_availability),
                    new SqlParameter("@fk_shipping_method", model.fk_shipping_method),
                    new SqlParameter("@fk_incoterms", model.fk_incoterms),
                    new SqlParameter("@model_pdf", model.model_pdf),
                    new SqlParameter("@note_public", model.note_public),
                    new SqlParameter("@note_private", model.note_private),
                    new SqlParameter("@date_delivery", model.date_delivery),
                    new SqlParameter("@location_incoterms", model.location_incoterms),
