...
function getMasters() {
    ...
    $.ajax({
        url: "/customsearch/filtermasters", type: "Get", data: { strValue1: 'QUOTE' },
...
function dataGridLoad() {
    ...
    let table_oh = $('#dtordersearch').DataTable({
        ...
        sAjaxSource: "/customsearch/quoteorder-list",
...
function ExportList() {
    ...
    postForm(option, '/customsearch/quoteorder-list-export');
}
