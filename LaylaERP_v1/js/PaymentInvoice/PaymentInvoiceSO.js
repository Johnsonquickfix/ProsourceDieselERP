        ...
        columns: [
            ...
            },
            {
                data: 'ref', title: 'PO No', sWidth: "12%", render: function (data, type, row) {
                    ...
                    return '<a href="javascript:void(0);" class="pdetailspo-control" data-toggle="tooltip" title="Click here to view order preview."><i class="glyphicon glyphicon-plus-sign"></i></a> #' + row.ref + ' <a href="#" title="Click here to print" data-toggle="tooltip" onclick="PrintProposals(' + row.id + ', false);"><i class="fas fa-search-plus"></i></a>';
...
function formatPO(d) {
    ...
    $.ajax({
        url: '/PaymentInvoice/GetPOOrderDataListSO', type: 'post', dataType: 'json', contentType: "application/json; charset=utf-8", data: JSON.stringify(option),
