...
function FillGrid(is_date) { 
    ...
    var table_EL = $('#dtdata').DataTable({
        ...
        aoColumns: [
            ...
            { data: 'POqty', title: 'Po. Qty', class: 'text-right', sWidth: "10%", render: $.fn.dataTable.render.number('', '.', 0, '') },
            { data: 'recqty', title: 'Received Qty', class: 'text-right', sWidth: "10%", render: $.fn.dataTable.render.number('', '.', 0, '') },
            { data: 'balqty', title: 'Balance Qty', class: 'text-right', sWidth: "10%", render: $.fn.dataTable.render.number('', '.', 0, '') }
        ...
        buttons: [
...

            {
                ...
                messageTop: function () { return '<h3 style = "text-align:center"> Layla Sleep Inc.</h3 ><br /><h3 style="text-align:left">PO Inventory Sheet</h3>'; },
            }
        ],
    });
}
